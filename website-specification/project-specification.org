...
** Navigation
   ...
   #+BEGIN_SRC emacs-lisp :results silent
     ...
     (with-temp-file "../_navigation-l0.org" (insert (cl-2020-preamble nil)))
     (with-temp-file "../_navigation-l1.org" (insert (cl-2020-preamble nil "../")))
     (with-temp-file "../_navigation-l2.org" (insert (cl-2020-preamble nil "../../")))
     (with-temp-file "../_navigation-l3.org" (insert (cl-2020-preamble nil "../../../")))
   #+END_SRC
